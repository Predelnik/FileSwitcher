...
#define NPPN_FIRST 1000
	...
	//scnNotification->nmhdr.idFrom = cmdID;
		...
		//	UCHAR _key;
		//};
#define NPPN_READONLYCHANGED (NPPN_FIRST + 16) // Temp declaration before 5.4.1 is out
	#define SYSTEM_READONLY    1
	#define USER_READONLY      2
	#define BUFFER_DIRTY	   4

#define NPPN_READONLYSET (NPPN_FIRST + 17)
#define NPPN_READONLYCLEAR (NPPN_FIRST + 18)
